...
public class Test {
    public static void main(String[] args) {
        ...
        System.out.println("CD on Main");
         System.out.println("CD on Main2");

    
        System.out.println("Cleansing - Update 1 on Local");
        ...
        System.out.println("Cleansing - Update 6 on taking back the Lead");
